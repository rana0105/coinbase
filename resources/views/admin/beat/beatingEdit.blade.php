      ...
      <div class="col-md-6 boxstyle">
        <form class="form-horizontal col-md-12"  form method="POST" action="{{ URL::route('beating.update', $beat->id) }}" >
          ...
          <div class="form-group">
            ...
            <input id="price" type="number" class="form-control @error('price') is-invalid @enderror" name="price" value="{{ $beat->price }}" required autocomplete="price" placeholder="Enter your price">
